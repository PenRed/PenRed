...
sed 's/__nx__/'${aa[0]}'/;s/__ny__/'${aa[1]}'/;s/__nz__/'${aa[2]}'/' ${DIR}/Comparison-depthactivity_template.gnu &> __CACA__
...
# Depth activity data files
sed 's/__srcdepthSet1__/'${DepthActivitySet1}'/;s/__srcdepthSet2__/'${DepthActivitySet2}'/' __CACA2__ &> __CACA__
sed 's/__srcdepthdirSet1__/'${DepthActivityDirSet1}'/;s/__srcdepthdirSet2__/'${DepthActivityDirSet2}'/' __CACA__ &> __CACA2__
sed 's/__titleSet1__/'${TitleSet1}'/;s/__titleSet2__/'${TitleSet2}'/' __CACA2__ &> __CACA__
