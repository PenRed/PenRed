...
#ifndef _PENRED_ICRP_AF_TISSUE_DATABASE_
#define _PENRED_ICRP_AF_TISSUE_DATABASE_
  ...
  namespace dataBases{
	...
	struct AF : public materials{
	  ...
	  static constexpr const std::array<massFraction, 9> ET1_0_8_ = {
	    ...
	    massFraction(6, 0.252),
	    massFraction(7, 0.027),
	    massFraction(8, 0.606),
	    massFraction(11, 0.001),
	    massFraction(15, 0.002),
	    massFraction(16, 0.003),
	    massFraction(17, 0.002),
	  ...
	  static constexpr const std::array<massFraction, 11> Humeri_upper_spongiosa = {
	    massFraction(1, 0.086),
	    massFraction(6, 0.392),
	    massFraction(7, 0.026),
	    massFraction(8, 0.39),
	    massFraction(11, 0.001),
	    massFraction(12, 0.001),
	    massFraction(15, 0.031),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.069)
	  };

	  static constexpr const std::array<massFraction, 7> Humeri_upper_medullary_cavity = {
	    massFraction(1, 0.115),
	    massFraction(6, 0.637),
	    massFraction(7, 0.007),
	    massFraction(8, 0.238),
	    massFraction(11, 0.001),
	  ...
	  static constexpr const std::array<massFraction, 9> Humeri_lower_spongiosa = {
	    ...
	    massFraction(6, 0.498),
	    massFraction(7, 0.017),
	    massFraction(8, 0.311),
	    massFraction(11, 0.001),
	    massFraction(15, 0.023),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(20, 0.052)
	  };
	  ...
	  static constexpr const std::array<massFraction, 9> Ulnae_and_radii_cortical = {
	    massFraction(1, 0.036),
	    massFraction(6, 0.159),
	    massFraction(7, 0.042),
	    massFraction(8, 0.448),
	  ...
	  static constexpr const std::array<massFraction, 11> Clavicles_spongiosa = {
	    massFraction(1, 0.085),
	    massFraction(6, 0.388),
	    massFraction(7, 0.026),
	    massFraction(8, 0.392),
	    massFraction(11, 0.001),
	    massFraction(12, 0.001),
	    massFraction(15, 0.032),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.071)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Cranium_spongiosa = {
	    massFraction(1, 0.079),
	    massFraction(6, 0.345),
	    massFraction(7, 0.029),
	    massFraction(8, 0.413),
	    massFraction(11, 0.002),
	    massFraction(12, 0.001),
	    massFraction(15, 0.039),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.088)
	  };
	  ...
	  static constexpr const std::array<massFraction, 10> Femora_upper_spongiosa = {
	    massFraction(1, 0.104),
	    massFraction(6, 0.501),
	    massFraction(7, 0.019),
	    massFraction(8, 0.342),
	    massFraction(11, 0.001),
	    massFraction(15, 0.009),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.02)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Mandible_spongiosa = {
	    massFraction(1, 0.086),
	    massFraction(6, 0.383),
	    massFraction(7, 0.027),
	    massFraction(8, 0.398),
	    massFraction(11, 0.001),
	    massFraction(12, 0.001),
	    massFraction(15, 0.031),
	    massFraction(16, 0.002),
	  ...
	  static constexpr const std::array<massFraction, 11> Pelvis_spongiosa = {
	    ...
	    massFraction(6, 0.422),
	    massFraction(7, 0.025),
	    massFraction(8, 0.394),
	    massFraction(11, 0.001),
	    massFraction(15, 0.018),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.039),
	    massFraction(26, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Ribs_spongiosa = {
	    massFraction(1, 0.098),
	    massFraction(6, 0.394),
	    massFraction(7, 0.029),
	    massFraction(8, 0.431),
	    massFraction(11, 0.001),
	    massFraction(15, 0.013),
	    massFraction(16, 0.002),
	    massFraction(17, 0.002),
	    massFraction(19, 0.001),
	    massFraction(20, 0.028),
	    massFraction(26, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 10> Scapulae_spongiosa = {
	    massFraction(1, 0.093),
	    massFraction(6, 0.426),
	    massFraction(7, 0.024),
	    massFraction(8, 0.382),
	    massFraction(11, 0.001),
	    massFraction(15, 0.022),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	    massFraction(19, 0.001),
	    massFraction(20, 0.048)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Cervical_spine_spongiosa = {
	    massFraction(1, 0.092),
	    massFraction(6, 0.371),
	    massFraction(7, 0.03),
	  ...
	  static constexpr const std::array<massFraction, 11> Thoracic_spine_spongiosa = {
	    massFraction(1, 0.098),
	    massFraction(6, 0.399),
	    massFraction(7, 0.029),
	    massFraction(8, 0.43),
	    massFraction(11, 0.001),
	    massFraction(15, 0.012),
	    massFraction(16, 0.002),
	    massFraction(17, 0.002),
	    massFraction(19, 0.001),
	    massFraction(20, 0.025),
	    massFraction(26, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Sacrum_spongiosa = {
	    ...
	    massFraction(11, 0.001),
	    massFraction(15, 0.007),
	    massFraction(16, 0.002),
	    massFraction(17, 0.002),
	    massFraction(19, 0.001),
	    massFraction(20, 0.014),
	    massFraction(26, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 11> Sternum_spongiosa = {
	    massFraction(1, 0.1),
	    massFraction(6, 0.403),
	    massFraction(7, 0.028),
	    massFraction(8, 0.429),
	    massFraction(11, 0.001),
	    massFraction(15, 0.011),
	    massFraction(16, 0.002),
	    massFraction(17, 0.002),
	    massFraction(19, 0.001),
	    massFraction(20, 0.022),
	    massFraction(26, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 7> Breast_left_adipose_tissue = {
	    ...
	    massFraction(6, 0.586),
	    massFraction(7, 0.008),
	    massFraction(8, 0.289),
	    massFraction(11, 0.001),
	    massFraction(16, 0.001),
	    massFraction(17, 0.001)
	  };
	  ...
	  static constexpr const std::array<massFraction, 8> Breast_left_glandular_tissue = {
	    ...
	    massFraction(6, 0.327),
	    massFraction(7, 0.03),
	    massFraction(8, 0.532),
	    massFraction(11, 0.001),
	    massFraction(15, 0.001),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001)
	  ...
	  static constexpr const std::array<massFraction, 9> Ovary_left = {
	    massFraction(1, 0.105),
	  ...
	  static constexpr const std::array<massFraction, 9> Ovary_right = {
	    massFraction(1, 0.105),
	    massFraction(6, 0.095),
	    massFraction(7, 0.025),
	    massFraction(8, 0.765),
	  ...
	  static constexpr const std::array<massFraction, 8> RST_head = {
	    massFraction(1, 0.112),
	    massFraction(6, 0.545),
	    massFraction(7, 0.01),
	    massFraction(8, 0.329),
	    massFraction(11, 0.001),
	    massFraction(15, 0.001),
	    massFraction(16, 0.001),
	    massFraction(17, 0.001)
	  ...
	  static constexpr const std::array<massFraction, 9> Salivary_gland_left = {
	    massFraction(1, 0.105),
	    massFraction(6, 0.252),
	    massFraction(7, 0.027),
	    massFraction(8, 0.606),
	  ...
	  static constexpr const std::array<massFraction, 9> Salivary_gland_right = {
	    massFraction(1, 0.105),
	    massFraction(6, 0.252),
	    massFraction(7, 0.027),
	    massFraction(8, 0.606),
	  ...
	  static constexpr const std::array<massFraction, 9> Urinary_bladder_wall_sensitive_69_116_ = {
	    massFraction(1, 0.105),
	    massFraction(6, 0.096),
	    massFraction(7, 0.026),
	    massFraction(8, 0.761),
	  ...
	  static constexpr const std::array<massFraction, 9> Uterus = {
	    massFraction(1, 0.106),
	    massFraction(6, 0.31),
	    massFraction(7, 0.024),
	    massFraction(8, 0.552),
	    massFraction(11, 0.001),
	    massFraction(15, 0.002),
	    massFraction(16, 0.002),
	    massFraction(17, 0.001),
	  ...
	  static constexpr const std::array<const char*, 187> names = {
	    "Adrenal_left",
	    "Adrenal_right",
	    "ET1(0-8)",
	    "ET1(8-40)",
	    ...
	    "Urinary_bladder_wall_sensitive(69-116)",
