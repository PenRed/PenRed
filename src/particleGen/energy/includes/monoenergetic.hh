...
#ifndef __MONOENERGETIC_ENERGY_SAMPLING__
#define __MONOENERGETIC_ENERGY_SAMPLING__

#include "pen_auxiliar.hh"

class monoenergetic : public abc_energySampler{
  DECLARE_SAMPLER(monoenergetic)
private:
